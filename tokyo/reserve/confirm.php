...
<div id="content" class="m15">
  ...
  <div id="yoyakuBtBox" class="clearfix">
    <div id="yoyakuBackBt">
      <form><input type="image" src="images/yoyakuBack.png" alt="戻る"></form>
    </div>
    <div id="yoyakuOkBt">
      <form action="finish.php" method="post"><input type="image" src="images/yoyakuSelect.png" alt="予約する"></form>
    </div>
  </div>
