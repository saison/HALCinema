...
(function($) {
    ...
    $.fn.juicyslider = function(options) {
        ...
        settings = $.extend({
            ...
            height: '350px', // otherwise set any other values in px or % unit
            mask: "raster", // "raster", "square", "strip" or "none"
            bgcolor: "#000",
            autoplay: 200, // 0 for no autoplay, any other postive number for play interval in (ms)
            shuffle: false, // set true to shuffle the picture order
            show: {effect: 'drop', duration: 1000}, // effect params refer to jQuery UI
            hide: {effect: 'drop', duration: 1000}, // try 'puff' or 'drop' for the effect arg
        }, options),               
        slides = this.find('li'),
