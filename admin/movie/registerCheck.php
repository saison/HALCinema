<?PHP
	...
	if(isset($_POST['send'])){// from register.php
		...
		$_SESSION['registerCheckCinemaName'] = htmlspecialchars($cinemaName);
		$_SESSION['registerCheckStartDay'] = $startDay ;
		$_SESSION['registerCheckEndDay'] = $endDay;
		$_SESSION['registerCheckRunningtime'] =$runningTime;
		$_SESSION['registerCheckMovieDescription'] = htmlspecialchars($cinemaDescription);
		$_SESSION['registerCheckMovieDirector'] = htmlspecialchars($movieDirector);
		$_SESSION['registerCheckPerfomer'] = htmlspecialchars($moviePerfomer);
		$_SESSION['registerCheckMainPhoto'] = $mainPhoto;
		$_SESSION['registerCheckSubPhoto1'] = $subPhoto1;
		$_SESSION['registerCheckSubPhoto2'] = $subPhoto2;
		$_SESSION['registerCheckSubPhoto3'] = $subPhoto3;
		$_SESSION['registerCheckSubPhoto4'] = $subPhoto4;
	...
	if($mainPhoto=="noImg.png"){
		$errorArray += array('mainPhoto'=>'1');	
	}
	...
	if(count($errorArray)==0){//エラーなし
		...
		header("Location:register.php?".http_build_query($errorArray)."");
	}
